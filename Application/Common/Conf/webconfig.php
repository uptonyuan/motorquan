...
//*************************************网站设置****************************************
    ...
    'WEB_ICP_NUMBER'            =>  '渝ICP备16001407号-1',       // 网站ICP备案号
    'ADMIN_EMAIL'               =>  '2993991515@qq.com',          // 站长邮箱

//*************************************优化推广****************************************
    'WEB_NAME'                  =>  '摩托圈',             //网站名：
    'WEB_KEYWORDS'              =>  '摩托圈,技术博客,个人博客',         //网站关键字
    'WEB_DESCRIPTION'           =>  '摩托圈官方网站',      //网站描述
    'AUTHOR'                    =>  '摩托圈',               //默认作者
    'COPYRIGHT_WORD'            =>  '本文为摩托圈原创文章,转载无需和我联系,但请注明来自摩托圈博客http://www.motorquan.com/',       //文章保留版权提示
    'IMAGE_TITLE_ALT_WORD'      =>  '摩托圈', //图片默认title和alt

//*************************************水印设置****************************************
    'WATER_TYPE'                =>  '1',           //水印类型 0:不使用水印 1:文字水印 2:图片水印 3:文字和图片水印同时使用
    'TEXT_WATER_WORD'           =>  'http://www.motorquan.com/',      //文字水印内容
